...
const Terms = () => {
  return (
    <>
      <HeaderSection />
      <div className="mt-16 mx-auto max-w-7xl px-6 py-6 lg:px-8">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl mb-2">
          Terms and Conditions
        </h1>
        <p className="mb-4">Last updated: June 08, 2023</p>
        <p className="mb-4">
        ...
        <ul className="list-disc list-outside mb-4">
          ...
          <li>
            <p className="mb-4">
              ...
              in this Agreement) refers to Autosistant.
            </p>
          </li>
          <li>
            <p className="mb-4">
          ...
          <li>
            <p className="mb-4">
              <strong>Website</strong> refers to Autosistant, accessible from{' '}
              <a
                href="https://autosistant.co"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://autosistant.co
              </a>
            </p>
          </li>
          <li>
